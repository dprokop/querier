(function (global, factory) {
	...
	(factory((global.querier = {}),global.React,global.PropTypes));
...
})(exports.QuerierState || (exports.QuerierState = {}));
...
var withDataFactory = function (queries) { return function (Component$$1) {
    var WithData = /** @class */ (function (_super) {
        ...
        WithData.prototype.render = function () {
            ...
            return (React.createElement(Component$$1, __assign({ results: results, actionQueries: this.getWrappedActionQueries(), states: states }, this.props)));
        };
                    ...
                    case 0:
                        ...
                        if (!!!hot &&
                            ...
                            (possibleQueryResult.result ||
                                possibleQueryResult.state.state === exports.QuerierState.Active)) {
...
//# sourceMappingURL=querier.umd.js.map
